...
public class book {
    ...
    // long rep_long=12L;
    // float rep_float=12F;
    // System.out.println("represent float and long respectively:"+rep_float,
    // rep_long); // Says cant print long using print or println
    //
    ...
    // rep_hexa + " " + rep_octal + " "
    // + rep_binary); // Says cant print string and int together using print or
    // println
